...
export const divisions: Division[] = [
  ...
  },
  {
    ...
    capacity: "AQL",
    description:
      "Final inspection to AQL standards, followed by steam pressing, folding, and retail-ready packing. Full capability for branded hang-tags, barcode labeling, and compliance documentation for each market.",
    icon: "Package",
  },
]
