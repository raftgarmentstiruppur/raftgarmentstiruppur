  ...
  return (
    <>
      ...
      <MarketingBanner
        ...
        description="Explore our full range of 150+ fabric constructions, 500+ color options, and 4 product categories ready for private label."
      ...
      <BrandNarrative
        ...
        body="For over three decades, Raft-Garments has built every thread of our reputation on one principle: true vertical integration. From our own spinning mills to our export-ready packaging lines, we control every step — so you never have to wonder about quality."
        ctaLabel="Our Story"
        ctaHref="/about"
        stat1={{ value: "18", label: "Manufacturing Facilities" }}
        stat2={{ value: "30+", label: "Years of Excellence" }}
        stat3={{ value: "100K", label: "Pieces Per Day" }}
      />
